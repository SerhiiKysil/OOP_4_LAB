...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        carListWidget_2 = new QListView(centralwidget);
        carListWidget_2->setObjectName("carListWidget_2");
        carListWidget_2->setGeometry(QRect(280, 130, 256, 192));
